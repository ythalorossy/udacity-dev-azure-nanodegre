...
class BaseConfig:
    ...
    SERVICE_BUS_CONNECTION_STRING = 'Endpoint=sb://yross-service-bus-1.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=lWRT/SO/HNQPIwYBp/jtJxvrFCuiVrTSTsYlE/ok+cs='
